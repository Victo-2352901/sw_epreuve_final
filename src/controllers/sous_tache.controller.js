import { requeteAjouterSousTache, requeteModifierSousTache, requeteModifierStatutSousTache, requeteSupprimerSousTache } from "../models/sous_tache.model.js";
  ...
  if (req.body.titre && req.body.titre != "" && req.body.tache_id && req.body.tache_id != "" && req.body.complete && req.body.complete != "") {
    ...
    .then((resultat) => {
      ...
      .catch((erreur) => {
        ...
        res.send({ message: "Erreur lors de la requête" });
      });
  } else {
    res.status(400);
